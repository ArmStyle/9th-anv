...
export const content: SiteContent = {
  ...
  sections: [
    ...
    { type: "quote", id: "quote-1", text: "ไม่ว่าจะไปไกลแค่ไหน บ้านของฉันก็คือตรงที่มีเธออยู่" },
    ...
    { type: "quote", id: "quote-2", text: "ทุกที่ที่ไป ฉันแค่อยากถ่ายรูปเธอไว้ให้ครบทุกมุม" },
